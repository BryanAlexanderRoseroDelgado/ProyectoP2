...
function cargarPerfiles() {
  ...
  <td>
    <button class="btn-editar" onclick="reproducirSonidomov(); editarUsuario('${clave}')" style="background: var(--color-botonedit); color: white; border: none; padding: 5px 10px; margin-right: 5px; border-radius: 4px;">Editar</button>
    <button class="btn-eliminar" onclick="reproducirSonidoborrar(); eliminarUsuario('${clave}')">Eliminar</button>
  </td>
`;
  ...
  <div class="card h-100 shadow-lg rounded-4 border-0"
    ...
    <div class="card-body d-flex flex-column">
      ...
      <div class="d-grid mt-auto">
        <button style="background: var(--color-botonedit)" 
        onclick="reproducirSonidomov()"class="btn btn-sm editar-producto mb-2"
                data-type="${producto.type}" 
                data-name="${producto.name}">
          Editar
        </button>
        
        <button onclick="reproducirSonidoborrar()"class="btn btn-danger btn-sm eliminar-producto mb-2"
                data-type="${producto.type}" 
                data-name="${producto.name}">
          Eliminar
        </button>
